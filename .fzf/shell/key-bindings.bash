...
# ------------
__fzf_select__() {
    #local cmd="${FZF_CTRL_T_COMMAND:-"command find -L . -mindepth 1 \\( -printf '%T@ %Tc %p ' \\) \\( -path '*/\\.*' -o -fstype 'sysfs' -o -fstype 'devfs' -o -fstype 'devtmpfs' -o -fstype 'proc' \\) -prune \
    #-o -type f -print \
    #-o -type d -print \
    #-o -type l -print 2> /dev/null \
   #| sort -r  "}"
    local cmd="${FZF_CTRL_T_COMMAND:-"command find -L . -mindepth 1  -maxdepth 1 -printf '%T@ %Tc %p\\n' 2> /dev/null \
